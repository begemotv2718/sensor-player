...
STM32_LIBSRC+=./stm32_lib/stm32f10x_rcc.c ./stm32_lib/stm32f10x_gpio.c ./stm32_lib/stm32f10x_usart.c ./stm32_lib/stm32f10x_spi.c ./stm32_lib/misc.c
SRC=main.c

OBJ=core_cm3.o system_stm32f10x.o startup_stm32f10x_md_vl.o
OBJ+=stm32f10x_rcc.o stm32f10x_gpio.o stm32f10x_usart.o stm32f10x_spi.o misc.o
OBJ+=usart.o queue.o main.o 
